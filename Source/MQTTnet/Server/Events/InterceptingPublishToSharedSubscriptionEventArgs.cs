...
{
    public sealed class InterceptingPublishToSharedSubscriptionEventArgs : EventArgs
    {
        public InterceptingPublishToSharedSubscriptionEventArgs(MqttApplicationMessage applicationMessage, CancellationToken cancellationToken, string clientId, string shareName, IDictionary sessionItems)
        {
